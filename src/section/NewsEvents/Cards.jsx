    ...
    <>
      <div className="flex gap-10 max-md:gap-10 max-sm:gap-7 py-10 pb-20 max-sm:py-10 flex-col px-32 max-sm:px-0 mt-5 max-md:mt-0">
        ...
        <div className="flex bg-orange-50 shadow-sm">
          <div className="px-12 max-sm:px-8 py-10">
            <h1 className="pb-2 text-4xl max-md:text-3xl relative font-Gamiliademo capitalize">
        ...
        <div className="flex bg-blue-50 shadow-sm">
          <div className="px-12 max-sm:px-8 py-10">
            <h1 className="pb-2 text-4xl max-md:text-3xl relative font-Gamiliademo capitalize mb-5">
            ...
            >
              ...
              <h3 className="font-CooperHevitt text-2xl mb-2 max-md:text-xl">
            ...
            <a
              ...
              className="cursor-pointer"
            >
              <h3 className="font-CooperHevitt text-2xl mb-2 mt-8  max-md:text-xl">
        ...
        <div className="flex bg-green-50 shadow-sm  rounded-sm">
          <div className="px-12 max-sm:px-8 py-10">
            ...
            <a
              ...
              className="cursor-pointer"
            >
              <h5 className="italic font-CooperHevitt text-xl max-md:text-lg my-1 font-bold">
